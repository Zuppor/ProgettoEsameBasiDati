...
if(isset($_POST['username'],$_POST['password'],$_POST['level'])){
    ...
    if($result === true){
        ...
        header('Location: ../frontend/login.php?error=Utente registrato correttamente. E\' possibile eseguire il login');
    }
    else{
    ...
    header('Location: ../frontend/register.php?error=Parametri non corretti');
}
